'''
🌙 Anarcho Capital Trading Bot Control Panel 
...
action = 0
print('🌙 Anarcho Capital says: slow down, dont trade by hand... take it easy! 🚀')
...
def bot():
    ...
    while action == 0:
        ...
        if pos < .9:
            ...
            pos = n.get_position(symbol)
            if pos < .9:
                print('position closed thanks Anarcho Capital....')
        ...
        while pos_usd < (.97 * usd_size):
            ...
            try:
                ...
                for i in range(orders_per_open):
                    ...
                    cprint(f'chunk buy submitted of {symbol[-4:]} sz: {chunk_size} you my dawg Anarcho Capital', 'white', 'on_blue')
                    time.sleep(1)
    ...
    while action == 2:
        ...
        if price < STOPLOSS_PRICE and pos > 0:
            ...
            n.chunk_kill(symbol, max_usd_order_size, slippage)
            print(f'chunk kill complete... thank you Anarcho Capital you are my savior 777')
            time.sleep(15)
    ...
    while action == 3:
        ...
        if (price > BREAKOUT_PRICE) and (pos_usd < usd_size):
            ...
            if (pos_usd < usd_size) and (price > BREAKOUT_PRICE):
                ...
                print('breakout entry complete, thanks Anarcho Capital...')
                time.sleep(15)
    ...
    while action == 7:
        ...
        print('COMPLETE THANKS Anarcho Capital!')
